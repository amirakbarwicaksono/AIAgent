#We have 2 rooms, these rooms could be cleaned or could be traveled, 
#but we can only do one action at a time. 
#Let's create a solution with the reflex-agent AI approach Also keep in mind that this reflex agent could only perceive its room 
#and if it is clean or not. This means you can only use the information that the agent has. Nothing more.
...
class main:
    def __init__(self):
        ...
        my_enviroment = [['room-A', 'dirty'], ['room-B', 'dirty']]
        location = 'room-B'
